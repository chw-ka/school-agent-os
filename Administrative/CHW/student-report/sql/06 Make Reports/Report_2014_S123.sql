...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[stpGenerateReport_S123_2014]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[stpGenerateReport_S123_2014]
GO

CREATE PROCEDURE dbo.stpGenerateReport_S123_2014
...
GO
stpGenerateReport_S123_2014 3, 1
GO
...
GO
stpGenerateReport_S123_2014 3, 2
GO
