...
def test(submissions):
    ...
    for idx, row in submissions.iterrows():
        ...
        if (section_mark >= 6):
            ...
            submissions.loc[idx, "mark1"] = 6
        elif (section_mark > 3):
            submissions.loc[idx, "marks"] += 4
            submissions.loc[idx, "mark1"] = 4
        elif (section_mark >= 1):
            submissions.loc[idx, "marks"] += 2
        ...
        submissions.loc[idx, "comments"] += aia_utils.get_comments(section_description, submissions.loc[idx, "mark1"], 6)
        ...
        submissions.loc[idx, "comments"] += aia_utils.get_comments(section_description, submissions.loc[idx, "mark2"], 7)
