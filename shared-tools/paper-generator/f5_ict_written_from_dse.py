...
WRITTEN_SLOT_PLAN: tuple[tuple[str, str, tuple[str, ...], tuple[str, ...], int, str], ...] = (
    ("b-01", "section_b", ("試算表", "IF", "COUNTIF", "SUMIF", "RANK", "XLOOKUP"), ("Paper1B_CompulsoryStructured",), 4, "試算表（公式）"),
    (
        "b-02",
        "section_b",
        ("硬件", "軟件", "作業系統", "人工智能", "物聯網"),
    ...
    ("b-03", "section_b", ("多媒體", "點陣圖", "壓縮", "向量圖"), ("Paper1B_CompulsoryStructured",), 4, "多媒體檔案與格式"),
    ("b-04", "section_b", ("算法", "偽代碼", "陣列", "迴圈"), ("Paper1B_CompulsoryStructured",), 4, "計算思維（編程）"),
    ("b-05", "section_b", ("數據庫", "SQL", "資料類型"), ("Paper1B_CompulsoryStructured",), 4, "數據組織與 SQL"),
    ("b-06", "section_b", ("RAM", "硬件", "SSD", "快取記憶體"), ("Paper1B_CompulsoryStructured",), 9, "硬件規格比較"),
    ("c-01", "section_c", ("ERD", "數據庫"), ("Paper2A_Database", "Paper2_Elective"), 6, "Module A — ERD"),
    ("c-02", "section_c", ("數據庫", "SQL", "主鍵", "外鍵"), ("Paper2A_Database", "Paper2_Elective"), 4, "Module A — 欄位限制"),
    ("c-03", "section_c", ("數據庫", "冗餘", "完整性"), ("Paper2A_Database", "Paper2_Elective"), 4, "Module A — 冗餘與完整性"),
    ("c-05", "section_c", ("數據庫", "SQL", "JOIN", "GROUP BY", "UNION", "MINUS"), ("Paper2A_Database", "Paper2_Elective"), 6, "Module A — SQL 綜合"),
    (
        "c-06",
        "section_c",
        ("算法", "二維陣列", "堆疊"),
